...
public class administrador extends Personal {
    ...
    public administrador(String idP, String Nombre, String Apellido, String sexo, String Tipo, String correo, String cel_ref, String Fecha_i, String FEcha_f) {
        super(idP, Nombre, Apellido, sexo, Tipo, correo, cel_ref, Fecha_i, FEcha_f);
    }
    
    public void InsertarADM() {
    ...
    String comando2 = "insert into adm values ('" + this.ci+ "');";
    c.ejecutarComando(comando2);
}
    public void modificaradm(){
    ...
    public void EliminarADM(){
        String comando2 = "delete from adm where ciadm = '"+this.ci+"' ";
        c.ejecutarComando(comando2);
        String comando = "delete from personal where ci = '"+this.ci+"'" ;
        c.ejecutarComando(comando);
    }
    public void mostraraADM( JTable tabla){
        ...
        String consulta = "select * from personal p where p.tipo = 'Administrador';";
